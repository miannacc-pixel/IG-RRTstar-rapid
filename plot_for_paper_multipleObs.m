...
% Change this name only when main.m is run with different parameters.
result_file = 'data/PRM_stigmergy_marker_off_N2000_lambda_1000_radius_05';
load(result_file)
...
if exist('marker_enabled','var') && marker_enabled
    title('PRM Stigmergy: With Marker')
else
    title('PRM Stigmergy: Without Marker')
end
...
% Use explicit legend handles so the many path and ellipse objects do not
