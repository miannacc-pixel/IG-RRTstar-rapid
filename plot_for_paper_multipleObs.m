...
% Log in the PRM result generated by main.m.
% Change this name only when main.m is run with different parameters.
load('data/PRM_stigmergy_N2000_alpha_02_radius_05')
